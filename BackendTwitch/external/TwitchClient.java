...
public class TwitchClient {
    private static final String TOKEN = "Bearer b6em1c0vpugl5b314egpl5r36wfi5o";
    private static final String CLIENT_ID = "hg5ixvr6q35op6c53tbyyoweh9uysr";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            return String.format(url, limit); // top game
        } else {
            try {
