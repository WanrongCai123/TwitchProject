package com.laioffer.jupiter.recommend;
...
//        return recommendedItems;
    ...
    private List<Item> recommendByFavoriteHistory(
        ...
        // Entry<String, Long> entry : map.entrySet()
...
//                TwitchClient client = new TwitchClient();
//                List<Game> topGames = client.topGames(DEFAULT_GAME_LIMIT);
//                recommendItemMap.put(entry.getValue().toString(), recommendByTopGames(ItemType.valueOf(entry.getValue())));
//            }
//            else {
//                recommendItemMap.put(entry.getKey().toString(), recommendByFavoriteHistory(favoriteItemIds));
//            }
//        }
//        return recommendItemMap;
//    }
